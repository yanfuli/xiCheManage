    ...
    <div class="table">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><i class="el-icon-tickets"></i>能源类型</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
...
<!--                <el-button type="primary" icon="search" @click="search">搜索</el-button>-->
            ...
            <el-table :data="tableData" border style="width: 100%" ref="multipleTable" @selection-change="handleSelectionChange">
                ...
                <el-table-column prop="title" label="能源名称">
                </el-table-column>
    ...
    export default {
        ...
        methods: {
            ...
            getData() {
                const that = this;
                let params = {
                    member_id: that.form.member_id,
                    limit: 20,
                    page: that.cur_page,
                }
                https.fetchPost('energy/index', params).then((e) => {
                    console.log(e)
                    if (e.code == 200) {
            ...
            saveEdit(form) {
                ...
                this.$refs[form].validate(valid => {
                    if (valid) {
                        if(this.isAdd === 2){
                            https.fetchPost('energy/update', that.form).then((e) => {
                                console.log(e)
                                if (e.code == 200) {
                                    console.log('成功')
                            ...
                            https.fetchPost('energy/create', that.form).then((e) => {
                                console.log(e)
                                if (e.code == 200) {
                                    console.log('成功')
            ...
            deleteRow(){
                ...
                https.fetchPost('energy/del',params ).then((e) => {
                    console.log(e)
                    if(e.code==200){
                        console.log('成功')
                        that.getData();
