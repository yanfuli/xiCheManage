...
<template>
  <div class="table">
    ...
    <div class="container">
        ...
        <el-row :gutter="10" class="row">
            <el-col :xs="4" :sm="4" :md="4" :lg="4" :xl="4">
                <div class="grid-content bg-purple label-text">抵用优惠券金额</div>
            </el-col>
            <el-col :xs="4" :sm="4" :md="4" :lg="4" :xl="4">
                <div class="grid-content bg-purple">{{allData.coupon_price}}</div>
            </el-col>
        </el-row>
        <el-row :gutter="10" class="row">
            <el-col :xs="4" :sm="4" :md="4" :lg="4" :xl="4">
    ...
    methods: {
      dataPost(){
        ...
        saveSub(){
            ...
            console.log(params)
            https.fetchPost('member_order/update',params ).then((e) => {
            console.log(e)
            if(e.code==200){
                console.log('成功')
                that.getData();
