    ...
    <div class="table">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><i class="el-icon-tickets"></i>服务项目分类</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            <div class="handle-box">
                ...
                <el-button type="primary" @click="addItem">添加服务项目分类</el-button>
            </div>
            <el-table :data="tableData" border style="width: 100%" ref="multipleTable" @selection-change="handleSelectionChange">
                <el-table-column type="selection" width="55"></el-table-column>
                <el-table-column prop="name" label="服务项目分类名称">
                </el-table-column>
    ...
    export default {
        ...
        methods: {
            ...
            getData() {
                ...
                https.fetchPost('service/index',params ).then((e) => {
                console.log(e)
                if(e.code==200){
            ...
            handleSee(row){
                var id = row.id;
                console.log(id)
                this.$router.push({ path: '/serviceItems', query: { id: id }})
            },
            // 全选删除
            delAll() {
            ...
            saveEdit(form) {
                 ...
                 this.$refs[form].validate(valid => {
                    ...
                    https.fetchPost('service/create',params ).then((e) => {
                    console.log(e)
                    if(e.code==200){
                        console.log('成功')
                        that.getData();
                ...
                if(that.dialogTitle=='编辑'){
                    ...
                    https.fetchPost('service/update',params ).then((e) => {
                        console.log(e)
                        if(e.code==200){
                            console.log('成功')
                            that.getData();
            ...
            deleteRow(){
                ...
                https.fetchPost('service/del',params ).then((e) => {
                    console.log(e)
                    if(e.code==200){
                        console.log('成功')
                        that.getData();
